...
/*   Updated: 2024/11/17 11:13:55 by hakaraou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mouse_hook(t_cub *cub)
{
	...
	w_center = WIDTH / 2;
	mlx_get_mouse_pos(cub->mlx.mlx_handle, &cub->x_cursor, &cub->y_cursor);
	...
	mlx_set_mouse_pos(cub->mlx.mlx_handle, WIDTH / 2, HEIGHT / 2);
}
